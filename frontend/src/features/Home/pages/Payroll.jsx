      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4">
            Payouts & Expense Operations
          </h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Run payouts in minutes, not days. Automatically calculate taxes, deductions, and reimbursements with 100% accuracy.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-green-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">One-Click Processing</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Generate monthly salaries instantly based on presence data. The system handles all calculations for earnings and deductions automatically.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-green-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Statutory Assurance</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-green-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Expense Claims</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Persons can upload receipts and claim reimbursements via the field console. Managers can approve them in a single click.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-green-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Automated Pay Statements</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Stop emailing PDFs manually. Persons can view and download their pay statements and tax sheets directly from their self-service portal.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#8B5CF6] rounded-3xl p-10 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">Make payouts stress-free</h2>
