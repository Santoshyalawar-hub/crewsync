    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>💸 Payouts & Assurance</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Payday in 5 minutes.<br />Not 5 days.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>India-compliant payouts that auto-calculates CTC, PF, ESI, TDS, and arrears from real presence data. One click sends salary to every bank account.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Direct bank transfer">
            <div style={{fontSize:28,marginBottom:12}}>🏦</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Direct bank transfer</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Bulk disburse salaries to any bank in India with a single click.</p>
          </div>
          <div className="gcard" key="TDS & PF auto-calc">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>TDS & PF auto-calc</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Income tax, EPF, ESI computed automatically — zero manual input.</p>
          </div>
          <div className="gcard" key="Digital pay statements">
            <div style={{fontSize:28,marginBottom:12}}>📄</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Digital pay statements</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Password-protected pay statements delivered to every employee's inbox.</p>
          </div>
          <div className="gcard" key="Arrears & revisions">
            <div style={{fontSize:28,marginBottom:12}}>🔁</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Arrears & revisions</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Handle salary revisions and arrears without breaking a sweat.</p>
          </div>
          <div className="gcard" key="CTC structuring">
            <div style={{fontSize:28,marginBottom:12}}>💼</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>CTC structuring</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Flexible salary heads — HRA, LTA, special allowances and more.</p>
          </div>
          <div className="gcard" key="Cost reports">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Cost reports</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Full payouts cost breakdown by department, role, and month.</p>
          </div>
        </div>
      </section>
