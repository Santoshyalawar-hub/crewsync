  ...
  return (
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'One platform.<br />Every People Studio need.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>From the first offer letter to the final full-and-final — CrewSync covers every step of the employee lifecycle. Here's everything it can do.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Presence Grid">
            <div style={{fontSize:28,marginBottom:12}}>⏱️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Presence Grid</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Biometric, GPS, QR, and face-recognition clock-ins in one system.</p>
          </div>
          <div className="gcard" key="Payouts & Assurance">
            <div style={{fontSize:28,marginBottom:12}}>💸</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Payouts & Assurance</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Auto-calculated TDS, PF, ESI and one-click bank disbursement.</p>
          </div>
          <div className="gcard" key="Time Away Flow">
            <div style={{fontSize:28,marginBottom:12}}>🏖️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Time Away Flow</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Custom policies, accruals, approval chains, and payouts sync.</p>
          </div>
          <div className="gcard" key="People Directory">
            <div style={{fontSize:28,marginBottom:12}}>👥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>People Directory</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Rich profiles, org charts, docs, and full lifecycle tracking.</p>
          </div>
          <div className="gcard" key="Signals Studio">
            <div style={{fontSize:28,marginBottom:12}}>📈</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Signals Studio</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Live dashboards, attrition analysis, cost reports, and exports.</p>
          </div>
          <div className="gcard" key="Joiner & Exit Flow">
            <div style={{fontSize:28,marginBottom:12}}>🚀</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Joiner & Exit Flow</h3>
