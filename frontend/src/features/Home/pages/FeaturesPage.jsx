    ...
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🎯 All Features</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0D1F2D',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'One platform.<br />Every HR need.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>From the first offer letter to the final full-and-final — SamayaHR covers every step of the employee lifecycle. Here's everything it can do.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Time & Attendance">
            <div style={{fontSize:28,marginBottom:12}}>⏱️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Time & Attendance</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Biometric, GPS, QR, and face-recognition clock-ins in one system.</p>
          </div>
          <div className="gcard" key="Payroll & Compliance">
            <div style={{fontSize:28,marginBottom:12}}>💸</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Payroll & Compliance</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Auto-calculated TDS, PF, ESI and one-click bank disbursement.</p>
          </div>
          <div className="gcard" key="Leave Management">
            <div style={{fontSize:28,marginBottom:12}}>🏖️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Leave Management</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Custom policies, accruals, approval chains, and payroll sync.</p>
          </div>
          <div className="gcard" key="Employee Directory">
            <div style={{fontSize:28,marginBottom:12}}>👥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Employee Directory</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Rich profiles, org charts, docs, and full lifecycle tracking.</p>
          </div>
          <div className="gcard" key="Analytics & Reports">
            <div style={{fontSize:28,marginBottom:12}}>📈</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Analytics & Reports</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Live dashboards, attrition analysis, cost reports, and exports.</p>
          </div>
          <div className="gcard" key="Onboarding & Exit">
            <div style={{fontSize:28,marginBottom:12}}>🚀</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Onboarding & Exit</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Digital joining, e-signatures, exit interviews, and clearance.</p>
          </div>
        </div>
      </section>
