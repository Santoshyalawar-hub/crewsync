    ...
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🔐 Security & Roles</span>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="AES-256 encryption">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>AES-256 encryption</h3>
          ...
          <div className="gcard" key="Two-factor auth">
            <div style={{fontSize:28,marginBottom:12}}>📱</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Two-factor auth</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Mandatory 2FA option for all admin and HR roles.</p>
          </div>
          <div className="gcard" key="SSO support">
            <div style={{fontSize:28,marginBottom:12}}>🔑</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>SSO support</h3>
          ...
          <div className="gcard" key="Audit log">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Audit log</h3>
          ...
          <div className="gcard" key="Role-based access">
            ...
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Granular permissions per module — Admin, HR, Manager, Employee.</p>
          </div>
          <div className="gcard" key="DPDPA 2023 ready">
            <div style={{fontSize:28,marginBottom:12}}>🌍</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>DPDPA 2023 ready</h3>
