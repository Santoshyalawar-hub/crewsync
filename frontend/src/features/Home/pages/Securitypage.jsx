    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🔐 Trust & Access</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Enterprise-grade security.<br />Startup-friendly price.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>AES-256 encryption, 2FA, SSO, and a tamper-proof audit log. Role-based access ensures every person sees only what they're supposed to.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="AES-256 encryption">
            <div style={{fontSize:28,marginBottom:12}}>🔒</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>AES-256 encryption</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>All data encrypted at rest and in transit — always.</p>
          </div>
          <div className="gcard" key="Two-factor auth">
            <div style={{fontSize:28,marginBottom:12}}>📱</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Two-factor auth</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Mandatory 2FA option for all admin and People Studio roles.</p>
          </div>
          <div className="gcard" key="SSO support">
            <div style={{fontSize:28,marginBottom:12}}>🔑</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>SSO support</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Google and Microsoft SSO for frictionless secure login.</p>
          </div>
          <div className="gcard" key="Audit log">
            <div style={{fontSize:28,marginBottom:12}}>👁️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Audit log</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Every action logged — who changed what and when.</p>
          </div>
          <div className="gcard" key="Role-based access">
            ...
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Granular permissions per module — Operator, People Studio, Manager, Person.</p>
          </div>
          <div className="gcard" key="DPDPA 2023 ready">
            <div style={{fontSize:28,marginBottom:12}}>🌍</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>DPDPA 2023 ready</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Compliant with India's Digital Personal Data Protection Act.</p>
          </div>
        </div>
      </section>
