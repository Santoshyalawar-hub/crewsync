      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0D1F2D',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'HR at scale.<br />Without the chaos.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Thousands of employees across multiple locations, entities, and compliance zones — SamayaHR handles it all with white-label branding, custom APIs, and dedicated support.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Multi-entity support">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Multi-entity support</h3>
          ...
          <div className="gcard" key="SSO & custom auth">
            <div style={{fontSize:28,marginBottom:12}}>🔑</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>SSO & custom auth</h3>
          ...
          <div className="gcard" key="White-label branding">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>White-label branding</h3>
          ...
          <div className="gcard" key="Open API">
            <div style={{fontSize:28,marginBottom:12}}>🔌</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Open API</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Connect SamayaHR to your ERP, CRM or any third-party system.</p>
          </div>
          <div className="gcard" key="Dedicated CSM">
            <div style={{fontSize:28,marginBottom:12}}>👨‍💼</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Dedicated CSM</h3>
          ...
          <div className="gcard" key="On-premise option">
            <div style={{fontSize:28,marginBottom:12}}>🖥️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>On-premise option</h3>
