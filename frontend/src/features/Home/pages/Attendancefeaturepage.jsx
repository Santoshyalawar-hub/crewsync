    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>⏱️ Presence Grid</span>
          ...
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Biometric, GPS, QR, and face-recognition clock-ins — all in one place. Presence data syncs directly to payouts so every rupee is accurate.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Auto-sync to payouts">
            <div style={{fontSize:28,marginBottom:12}}>🔄</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Auto-sync to payouts</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>No manual data entry — presence drives salary calculations automatically.</p>
          </div>
          <div className="gcard" key="GPS geo-fencing">
            <div style={{fontSize:28,marginBottom:12}}>📍</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>GPS geo-fencing</h3>
          ...
          <div className="gcard" key="Shift & roster planner">
            <div style={{fontSize:28,marginBottom:12}}>📅</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Shift & roster planner</h3>
          ...
          <div className="gcard" key="Overtime tracking">
            <div style={{fontSize:28,marginBottom:12}}>⏰</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Overtime tracking</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Auto-flag overtime hours and calculate compensation per policy.</p>
          </div>
          <div className="gcard" key="Pocket clock-in">
            <div style={{fontSize:28,marginBottom:12}}>📲</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Pocket clock-in</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Persons mark presence from their phone, anywhere.</p>
          </div>
          <div className="gcard" key="Presence analytics">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Presence analytics</h3>
