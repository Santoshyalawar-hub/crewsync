    ...
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>⏱️ Time & Attendance</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0D1F2D',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Track every minute.<br />Miss nothing.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Biometric, GPS, QR, and face-recognition clock-ins — all in one place. Attendance data syncs directly to payroll so every rupee is accurate.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Auto-sync to payroll">
            <div style={{fontSize:28,marginBottom:12}}>🔄</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Auto-sync to payroll</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>No manual data entry — attendance drives salary calculations automatically.</p>
          </div>
          <div className="gcard" key="GPS geo-fencing">
            <div style={{fontSize:28,marginBottom:12}}>📍</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>GPS geo-fencing</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Validate check-ins by location to prevent buddy punching.</p>
          </div>
          <div className="gcard" key="Shift & roster planner">
            <div style={{fontSize:28,marginBottom:12}}>📅</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Shift & roster planner</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Build weekly schedules with drag-and-drop ease.</p>
          </div>
          <div className="gcard" key="Overtime tracking">
            <div style={{fontSize:28,marginBottom:12}}>⏰</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Overtime tracking</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Auto-flag overtime hours and calculate compensation per policy.</p>
          </div>
          <div className="gcard" key="Mobile clock-in">
            <div style={{fontSize:28,marginBottom:12}}>📲</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Mobile clock-in</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Employees mark attendance from their phone, anywhere.</p>
          </div>
          <div className="gcard" key="Attendance analytics">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Attendance analytics</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>See late arrivals, absenteeism trends and team patterns at a glance.</p>
          </div>
        </div>
      </section>
