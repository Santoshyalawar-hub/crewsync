    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>👥 People Directory</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Every employee.<br />One place.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>A rich, searchable directory with org charts, role history, documents, and emergency contacts. Your single source of truth for everything people-related.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Complete profiles">
            <div style={{fontSize:28,marginBottom:12}}>🗂️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Complete profiles</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Photo, role, department, bank details, documents — all in one card.</p>
          </div>
          <div className="gcard" key="Org chart view">
            <div style={{fontSize:28,marginBottom:12}}>🌳</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Org chart view</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Visualise your entire company hierarchy at any level.</p>
          </div>
          <div className="gcard" key="Document vault">
            <div style={{fontSize:28,marginBottom:12}}>📁</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Document vault</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Store offer letters, ID proofs, contracts securely per employee.</p>
          </div>
          <div className="gcard" key="Smart search">
            <div style={{fontSize:28,marginBottom:12}}>🔍</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Smart search</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Find anyone by name, department, role, or skill in seconds.</p>
          </div>
          <div className="gcard" key="Lifecycle tracking">
            <div style={{fontSize:28,marginBottom:12}}>📝</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Lifecycle tracking</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Joiner Flow to exit — every status change is logged automatically.</p>
          </div>
          <div className="gcard" key="Role-based access">
            <div style={{fontSize:28,marginBottom:12}}>🔐</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Role-based access</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>People Studio sees everything; employees see only what they need.</p>
          </div>
        </div>
      </section>
