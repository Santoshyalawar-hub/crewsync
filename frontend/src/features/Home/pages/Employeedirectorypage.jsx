    ...
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>👥 Employee Directory</span>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Complete profiles">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Complete profiles</h3>
          ...
          <div className="gcard" key="Org chart view">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Org chart view</h3>
          ...
          <div className="gcard" key="Document vault">
            <div style={{fontSize:28,marginBottom:12}}>📁</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Document vault</h3>
          ...
          <div className="gcard" key="Smart search">
            <div style={{fontSize:28,marginBottom:12}}>🔍</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Smart search</h3>
          ...
          <div className="gcard" key="Lifecycle tracking">
            <div style={{fontSize:28,marginBottom:12}}>📝</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Lifecycle tracking</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Onboarding to exit — every status change is logged automatically.</p>
          </div>
          <div className="gcard" key="Role-based access">
            <div style={{fontSize:28,marginBottom:12}}>🔐</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Role-based access</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>HR sees everything; employees see only what they need.</p>
          </div>
        </div>
      </section>
