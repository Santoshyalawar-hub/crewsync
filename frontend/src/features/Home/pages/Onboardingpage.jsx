    ...
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🚀 Onboarding & Offboarding</span>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Digital offer letters">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Digital offer letters</h3>
          ...
          <div className="gcard" key="E-signatures">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>E-signatures</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Employees sign documents digitally — no printing, scanning or couriers.</p>
          </div>
          <div className="gcard" key="Joining checklists">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Joining checklists</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Customisable onboarding tasks assigned to HR, IT and the new hire.</p>
          </div>
          <div className="gcard" key="Welcome kits">
            <div style={{fontSize:28,marginBottom:12}}>🎁</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Welcome kits</h3>
          ...
          <div className="gcard" key="Structured exits">
            <div style={{fontSize:28,marginBottom:12}}>🚪</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Structured exits</h3>
          ...
          <div className="gcard" key="NOC & clearance">
            <div style={{fontSize:28,marginBottom:12}}>✅</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>NOC & clearance</h3>
