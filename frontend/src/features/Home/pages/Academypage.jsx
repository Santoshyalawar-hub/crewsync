      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Grow your People Studio career.<br />At your own pace.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Free courses, certifications, and live webinars on People Studio operations, compliance, payouts, and leadership — built for Indian People Studio professionals.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Free certifications">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Free certifications</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Earn CrewSync-certified People Studio professional credentials online.</p>
          </div>
          <div className="gcard" key="Live webinars">
            <div style={{fontSize:28,marginBottom:12}}>📅</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Live webinars</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Monthly sessions with India's top People Studio leaders — free to join.</p>
          </div>
          <div className="gcard" key="Learning paths">
            <div style={{fontSize:28,marginBottom:12}}>🏆</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Learning paths</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Curated courses for People Studio Generalists, Payouts Managers, and CPeople StudioOs.</p>
          </div>
          <div className="gcard" key="Assurance courses">
            <div style={{fontSize:28,marginBottom:12}}>📄</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Assurance courses</h3>
          ...
          <div className="gcard" key="Self-paced modules">
            <div style={{fontSize:28,marginBottom:12}}>🔖</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Self-paced modules</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Learn in 15-minute bites — perfect for busy People teams.</p>
          </div>
          <div className="gcard" key="Peer community">
            <div style={{fontSize:28,marginBottom:12}}>🤝</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Peer community</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Connect with 10,000+ People Studio professionals across India.</p>
          </div>
        </div>
      </section>
