...
export default function TimeAwayOperationsFeaturePage() {
  return (
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🏖️ Time Away Flow</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Time Away policies that<br />run themselves.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Custom time away types, accrual rules, holiday calendars, and multi-level approvals — set it up once and let CrewSync handle the rest.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Custom time away types">
            <div style={{fontSize:28,marginBottom:12}}>🗓️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Custom time away types</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Create Casual, Sick, Earned, Maternity and any other time away type.</p>
          </div>
          <div className="gcard" key="One-tap approvals">
            <div style={{fontSize:28,marginBottom:12}}>✅</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>One-tap approvals</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Managers approve or reject time away requests from mobile or web.</p>
          </div>
          <div className="gcard" key="Holiday calendar">
            <div style={{fontSize:28,marginBottom:12}}>📆</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Holiday calendar</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Define national and company-specific holidays per location.</p>
          </div>
          <div className="gcard" key="Auto accruals">
            <div style={{fontSize:28,marginBottom:12}}>🔢</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Auto accruals</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Time Aways accrue monthly, quarterly or yearly — automatically.</p>
          </div>
          <div className="gcard" key="Time Away balance tracker">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Time Away balance tracker</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Persons always know how many days they have left.</p>
          </div>
          <div className="gcard" key="Payouts integration">
            <div style={{fontSize:28,marginBottom:12}}>🔗</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Payouts integration</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Approved time away instantly reflect in that month's payouts.</p>
          </div>
        </div>
      </section>
