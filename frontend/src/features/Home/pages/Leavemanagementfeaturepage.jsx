...
export default function LeaveManagementFeaturePage() {
  return (
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🏖️ Leave Management</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0D1F2D',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Leave policies that<br />run themselves.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Custom leave types, accrual rules, holiday calendars, and multi-level approvals — set it up once and let SamayaHR handle the rest.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Custom leave types">
            <div style={{fontSize:28,marginBottom:12}}>🗓️</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Custom leave types</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Create Casual, Sick, Earned, Maternity and any other leave type.</p>
          </div>
          <div className="gcard" key="One-tap approvals">
            <div style={{fontSize:28,marginBottom:12}}>✅</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>One-tap approvals</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Managers approve or reject leave requests from mobile or web.</p>
          </div>
          <div className="gcard" key="Holiday calendar">
            <div style={{fontSize:28,marginBottom:12}}>📆</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Holiday calendar</h3>
          ...
          <div className="gcard" key="Auto accruals">
            <div style={{fontSize:28,marginBottom:12}}>🔢</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Auto accruals</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Leaves accrue monthly, quarterly or yearly — automatically.</p>
          </div>
          <div className="gcard" key="Leave balance tracker">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Leave balance tracker</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Employees always know how many days they have left.</p>
          </div>
          <div className="gcard" key="Payroll integration">
            <div style={{fontSize:28,marginBottom:12}}>🔗</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Payroll integration</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Approved leaves instantly reflect in that month's payroll.</p>
          </div>
        </div>
      </section>
