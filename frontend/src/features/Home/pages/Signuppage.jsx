      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Your People Studio transformation<br />starts right now.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Set up CrewSync for your company in under 5 minutes. Free for your first 10 employees — no credit card, no contracts, no catch.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          ...
          <div className="gcard" key="Free for 10 employees">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Free for 10 employees</h3>
          ...
          <div className="gcard" key="Secure from day one">
            <div style={{fontSize:28,marginBottom:12}}>🔐</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Secure from day one</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>AES-256 encryption and 2FA enabled automatically.</p>
          </div>
          <div className="gcard" key="Pocket app included">
            <div style={{fontSize:28,marginBottom:12}}>📱</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Pocket app included</h3>
          ...
          <div className="gcard" key="No IT team needed">
            <div style={{fontSize:28,marginBottom:12}}>🚀</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>No IT team needed</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Self-serve onboarding — no implementation project required.</p>
          </div>
          <div className="gcard" key="Joiner Flow support">
            <div style={{fontSize:28,marginBottom:12}}>🤝</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Joiner Flow support</h3>
