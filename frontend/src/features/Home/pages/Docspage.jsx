      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Quick start guide">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Quick start guide</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Get SamayaHR set up for your company in under 15 minutes.</p>
          </div>
          <div className="gcard" key="API reference">
            <div style={{fontSize:28,marginBottom:12}}>🔌</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>API reference</h3>
          ...
          <div className="gcard" key="Video tutorials">
            <div style={{fontSize:28,marginBottom:12}}>🎥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Video tutorials</h3>
          ...
          <div className="gcard" key="Integration guides">
            <div style={{fontSize:28,marginBottom:12}}>🔗</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Integration guides</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Connect to Slack, Tally, Zoho, and 50+ other tools.</p>
          </div>
          <div className="gcard" key="HR templates">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>HR templates</h3>
          ...
          <div className="gcard" key="Community forum">
            <div style={{fontSize:28,marginBottom:12}}>💬</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Community forum</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Ask questions and share tips with 5,000+ SamayaHR users.</p>
          </div>
        </div>
      </section>
