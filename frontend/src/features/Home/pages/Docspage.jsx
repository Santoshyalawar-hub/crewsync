    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>📖 Documentation</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Everything you need<br />to get started fast.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Step-by-step guides, API references, video walkthroughs, and integration docs — all in one searchable place.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Quick start guide">
            <div style={{fontSize:28,marginBottom:12}}>🚀</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Quick start guide</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Get CrewSync set up for your company in under 15 minutes.</p>
          </div>
          <div className="gcard" key="API reference">
            <div style={{fontSize:28,marginBottom:12}}>🔌</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>API reference</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Full REST API docs with code examples for developers.</p>
          </div>
          <div className="gcard" key="Video tutorials">
            <div style={{fontSize:28,marginBottom:12}}>🎥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Video tutorials</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Screen-recorded walkthroughs for every major feature.</p>
          </div>
          <div className="gcard" key="Integration guides">
            <div style={{fontSize:28,marginBottom:12}}>🔗</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Integration guides</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Connect to Slack, Tally, Zoho, and 50+ other tools.</p>
          </div>
          <div className="gcard" key="People Studio templates">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>People Studio templates</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Download ready-made offer letters, policies, and forms.</p>
          </div>
          <div className="gcard" key="Community forum">
            <div style={{fontSize:28,marginBottom:12}}>💬</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Community forum</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Ask questions and share tips with 5,000+ CrewSync users.</p>
          </div>
        </div>
      </section>
