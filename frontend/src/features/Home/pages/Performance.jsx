      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-purple-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Goal Setting (OKRs)</h3>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-purple-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">360-Degree Feedback</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-purple-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Appraisal Cycles</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-purple-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Skill Matrix & Training</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
