      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Track work hours, manage shifts, and handle time away requests effortlessly with biometric integration and geo-tagging.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-orange-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Biometric & Geo-Fencing</h3>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-orange-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Shift Operations</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Create complex shift rosters, handle rotations, and manage weekly offs. Persons can view their schedules instantly on the app.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-orange-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Time Away Flow</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Customizable time away policies (Sick, Casual, Earned). Persons apply online, managers approve in a click, and balances update automatically.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-orange-200 transition-colors">
            <h3 className="text-xl font-bold text-[#8B5CF6] mb-3">Overtime Tracking</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Automatically calculate overtime hours based on your company policies and sync the data directly with payouts for payment.
            </p>
          </div>
        </div>
