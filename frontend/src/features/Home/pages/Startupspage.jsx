      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0D1F2D',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'HR built for the<br />speed of a startup.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>From your first hire to your fiftieth, SamayaHR scales with you. Automate the admin, stay compliant, and keep your team focused on building — not paperwork.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          ...
          <div className="gcard" key="Free forever (≤10)">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Free forever (≤10)</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Zero cost for your first 10 employees — upgrade only when ready.</p>
          </div>
          <div className="gcard" key="Mobile-first">
            <div style={{fontSize:28,marginBottom:12}}>📱</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Mobile-first</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Your team clocks in, checks payslips, and applies leaves on the go.</p>
          </div>
          <div className="gcard" key="Digital onboarding">
            <div style={{fontSize:28,marginBottom:12}}>🚀</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Digital onboarding</h3>
          ...
          <div className="gcard" key="Bank-grade security">
            <div style={{fontSize:28,marginBottom:12}}>🔐</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Bank-grade security</h3>
          ...
          <div className="gcard" key="Real-time analytics">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Real-time analytics</h3>
