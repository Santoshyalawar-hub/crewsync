    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🏥 For Healthcare</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'People Studio that keeps pace<br />with your care teams.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Credential tracking, 24/7 shift scheduling, and compliance-ready reporting for hospitals, clinics, and healthcare networks of any size.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="24/7 shift rostering">
            <div style={{fontSize:28,marginBottom:12}}>🕐</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>24/7 shift rostering</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Plan morning, evening, and night shifts without overlap or gaps.</p>
          </div>
          <div className="gcard" key="Credential management">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Credential management</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Track licences, certifications, and renewal dates per staff member.</p>
          </div>
          <div className="gcard" key="Assurance reports">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Assurance reports</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Generate audit-ready reports for NABH, JCI, and other bodies.</p>
          </div>
          <div className="gcard" key="Time Away during critical periods">
            <div style={{fontSize:28,marginBottom:12}}>💉</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Time Away during critical periods</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Smart time away controls to maintain minimum staffing at all times.</p>
          </div>
          <div className="gcard" key="Multi-department">
            <div style={{fontSize:28,marginBottom:12}}>🏥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Multi-department</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Separate policies for OT, ICU, OPD, and admin teams.</p>
          </div>
          <div className="gcard" key="Data privacy">
            <div style={{fontSize:28,marginBottom:12}}>🔐</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Data privacy</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Patient data never touches People Studio — strict role-based access enforced.</p>
          </div>
        </div>
      </section>
