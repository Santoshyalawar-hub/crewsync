  ...
  return (
    <div style={{minHeight:'100vh',background:'#F7F8FA'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0D1F2D',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Grow your team.<br />Not your HR headaches.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>SamayaHR gives 50–500 person businesses a full HR stack — payroll, attendance, leaves, and performance — without a big IT budget or implementation timeline.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="One-click payroll">
            <div style={{fontSize:28,marginBottom:12}}>🏦</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>One-click payroll</h3>
          ...
          <div className="gcard" key="Statutory compliance">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Statutory compliance</h3>
          ...
          <div className="gcard" key="Multi-department support">
            <div style={{fontSize:28,marginBottom:12}}>👥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Multi-department support</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Separate policies, holidays, and approval chains per department.</p>
          </div>
          <div className="gcard" key="HR dashboards">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>HR dashboards</h3>
          ...
          <div className="gcard" key="Self-service app">
            <div style={{fontSize:28,marginBottom:12}}>📱</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Self-service app</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Employees raise requests without calling HR — saves hours every week.</p>
          </div>
          <div className="gcard" key="Payroll-attendance sync">
            <div style={{fontSize:28,marginBottom:12}}>🔗</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0D1F2D',marginBottom:6}}>Payroll-attendance sync</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Attendance data flows directly into payroll — zero manual work.</p>
          </div>
        </div>
      </section>
