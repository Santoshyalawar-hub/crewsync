    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          <span className="sl" style={{marginBottom:20,display:'inline-flex'}}>🏢 For Small Business</span>
          <h1 className="fd" style={{fontSize:'clamp(2rem,5vw,3rem)',fontWeight:900,color:'#0B1020',lineHeight:1.12,marginBottom:20,marginTop:16}}
            dangerouslySetInnerHTML={{ __html: 'Grow your team.<br />Not your People Studio headaches.' }} />
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>CrewSync gives 50–500 person businesses a full People Studio stack — payouts, presence, time away, and performance — without a big IT budget or implementation timeline.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="One-click payouts">
            <div style={{fontSize:28,marginBottom:12}}>🏦</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>One-click payouts</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Run salaries for hundreds of employees in under 5 minutes.</p>
          </div>
          <div className="gcard" key="Statutory compliance">
            <div style={{fontSize:28,marginBottom:12}}>📋</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Statutory compliance</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>PF, ESI, TDS auto-calculated — no more last-minute CA calls.</p>
          </div>
          <div className="gcard" key="Multi-department support">
            <div style={{fontSize:28,marginBottom:12}}>👥</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Multi-department support</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Separate policies, holidays, and approval chains per department.</p>
          </div>
          <div className="gcard" key="People Studio Boards">
            <div style={{fontSize:28,marginBottom:12}}>📊</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>People Studio Boards</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Monitor attrition, headcount, and cost from a single screen.</p>
          </div>
          <div className="gcard" key="Self-service app">
            <div style={{fontSize:28,marginBottom:12}}>📱</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Self-service app</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Persons raise requests without calling People Studio — saves hours every week.</p>
          </div>
          <div className="gcard" key="Payouts-presence sync">
            <div style={{fontSize:28,marginBottom:12}}>🔗</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Payouts-presence sync</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Presence data flows directly into payouts — zero manual work.</p>
          </div>
        </div>
      </section>
