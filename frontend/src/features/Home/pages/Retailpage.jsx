    ...
    <div style={{minHeight:'100vh',background:'#F6F8FB'}}>
      ...
      <section style={{background:'linear-gradient(160deg,#fff 0%,#fff8f5 100%)',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:700,margin:'0 auto'}}>
          ...
          <p style={{fontSize:17,color:'#6b7280',lineHeight:1.75,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>Shift scheduling, biometric presence, and high-volume payouts for retail and FMCG teams — across stores, warehouses, and distribution centres.</p>
      ...
      <section style={{maxWidth:1100,margin:'0 auto',padding:'72px 24px'}}>
        ...
        <div className="grid3">
          <div className="gcard" key="Shift scheduling">
            ...
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Shift scheduling</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Build daily and weekly rosters across dozens of stores instantly.</p>
          </div>
          <div className="gcard" key="Biometric presence">
            <div style={{fontSize:28,marginBottom:12}}>🤖</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Biometric presence</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Face-recognition kiosks at store entry — no touch required.</p>
          </div>
          <div className="gcard" key="High-volume payouts">
            <div style={{fontSize:28,marginBottom:12}}>💸</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>High-volume payouts</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Process hundreds of pay statements with different wage slabs in minutes.</p>
          </div>
          <div className="gcard" key="Multi-location support">
            <div style={{fontSize:28,marginBottom:12}}>🏪</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Multi-location support</h3>
          ...
          <div className="gcard" key="Attrition tracking">
            <div style={{fontSize:28,marginBottom:12}}>📉</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Attrition tracking</h3>
          ...
          <div className="gcard" key="Field force app">
            <div style={{fontSize:28,marginBottom:12}}>📲</div>
            <h3 className="fd" style={{fontSize:16,fontWeight:800,color:'#0B1020',marginBottom:6}}>Field force app</h3>
            <p style={{fontSize:13,color:'#6b7280',lineHeight:1.7}}>Delivery and sales staff mark presence and expenses from mobile.</p>
          </div>
        </div>
      </section>
