...
import com.samayahr.entity.CorrectionRequest;
...
import com.samayahr.repository.CorrectionRequestRepository;
...
public class AdminAttendanceService {
    ...
    public List<Map<String, Object>> getLiveAttendance() {
        ...
        for (User employee : allEmployees) {
            ...
            employeeData.put("employeeCode", employee.getEmployeeId());
...
//✅ ADD THESE METHODS to your AdminAttendanceService
    ...
    public List<Map<String, Object>> getWeeklyAttendance(String from, String to, String tenantCode) {
        List<Map<String, Object>> result = new ArrayList<>();
        try {
            ...
            for (LocalDate d = fromDate; !d.isAfter(toDate); d = d.plusDays(1)) {
                ...
                long present = attendanceSessionRepository.findAll().stream()
                ...
                entry.put("presentCount", present);
                result.add(entry);
            }
        } catch (Exception e) {
