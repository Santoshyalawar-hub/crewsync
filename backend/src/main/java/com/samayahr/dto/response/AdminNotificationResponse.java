...
public class AdminNotificationResponse {
    ...
    /**
     * Cloudinary https:// URL for the attachment.
     * Previously the frontend had to construct a URL from attachmentPath.
     * Now this field contains the direct CDN URL — use it as-is in <a href> or download.
     */
