...
public class Document {
    ...
    // Cloudinary URL of the signed copy uploaded by the employee
    @Column(name = "signed_file_url", length = 1000)
    private String signedFileUrl;

    // Public ID on Cloudinary for the signed file (for deletion/replacement)
    @Column(name = "signed_file_public_id", length = 500)
    private String signedFilePublicId;

    // Name of the person who signed this document
    @Column(name = "signer_name", length = 255)
    private String signerName;

    // Whether the document has been digitally signed by the employee
    ...
    // No-arg constructor only — JPA requires it
    public Document() {}

    @Transient
    public String getFileUrl() { return this.filePath; }
